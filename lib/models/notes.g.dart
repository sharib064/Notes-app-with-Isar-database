...
extension NotesQueryFilter on QueryBuilder<Notes, Notes, QFilterCondition> {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textEqualTo(
    String value, {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'text',
        value: '',
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> textIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'text',
        value: '',
...
extension NotesQuerySortBy on QueryBuilder<Notes, Notes, QSortBy> {
  ...
  QueryBuilder<Notes, Notes, QAfterSortBy> sortByTextDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NotesQuerySortThenBy on QueryBuilder<Notes, Notes, QSortThenBy> {
  ...
  QueryBuilder<Notes, Notes, QAfterSortBy> thenByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }

  QueryBuilder<Notes, Notes, QAfterSortBy> thenByTextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.desc);
    });
  }
...
extension NotesQueryProperty on QueryBuilder<Notes, Notes, QQueryProperty> {
  ...
  QueryBuilder<Notes, String, QQueryOperations> textProperty() {
    return QueryBuilder.apply(this, (query) {
